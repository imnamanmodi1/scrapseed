    ...
    .catch(async () => {
      ...
      if (emailError) {
        ...
        return Promise.reject(
          new Error(`linkedin: invalid username: ${email}`)
        );
      }
      ...
      logger.error(
        "login",
        "could not find any element to retrieve a proper error"
      );
      return Promise.reject(
        new Error(
          "login is not working, please report: https://github.com/leonardiwagner/scrapedin/issues"
        )
      );
    });
};
